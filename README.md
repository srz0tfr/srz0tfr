...
**Software Engineer | AI | Distributed Systems | Backend Systems**

Building scalable backend systems, data pipelines, and intelligent platforms that perform under real world load.

---

## 🧑‍💻 About Me

- Software Engineer with experience building high concurrency backend services and data intensive systems.
- Master’s in Computer Science with focus on Artificial Intelligence and Distributed Systems.
- Strong interest in system design, performance optimization, and applied machine learning.
- Enjoy working on problems involving scale, reliability, and automation.
...
⚡ Built with focus on clean design, scalability, and performance.
